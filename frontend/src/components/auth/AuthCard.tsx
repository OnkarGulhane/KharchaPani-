...
export const AuthCard: React.FC<AuthCardProps> = ({
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 sm:p-6 md:p-8 bg-[#070b14] relative overflow-hidden select-none">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[550px] h-[550px] bg-indigo-500/5 rounded-full blur-[140px] pointer-events-none" />
      ...
      <motion.div
        ...
        className={`w-full ${maxWidthClass} bg-slate-900/80 backdrop-blur-2xl border border-slate-800/80 rounded-2xl sm:rounded-3xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.7)] p-6 sm:p-8 z-10 relative overflow-hidden select-text`}
      >
          ...
          >
            <div className="w-11 h-11 rounded-2xl bg-gradient-to-tr from-emerald-500 via-teal-500 to-indigo-500 p-0.5 shadow-lg shadow-emerald-500/20 group-hover:shadow-emerald-500/35 transition-all">
              <div className="w-full h-full bg-slate-950 rounded-[14px] flex items-center justify-center">
                <Wallet className="w-5 h-5 text-emerald-400 transition-transform group-hover:rotate-[-6deg]" />
              </div>
            </div>
            <div className="text-left">
              <div className="flex items-center gap-1.5">
                <span className="text-xl font-bold bg-gradient-to-r from-white via-slate-100 to-slate-200 bg-clip-text text-transparent tracking-tight leading-tight font-sans">
                  Kharcha<span className="text-emerald-400">Pani</span>
                </span>
                <span className="inline-flex items-center px-1.5 py-0.2 rounded text-[9px] font-bold bg-emerald-500/15 text-emerald-400 border border-emerald-500/30 uppercase tracking-wider">
                  <Sparkles className="w-2.5 h-2.5 mr-0.5" /> PRO
                </span>
              </div>
              <span className="text-[10px] font-medium tracking-wide text-slate-400 block">
